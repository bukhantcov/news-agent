...
DB_FILE = "gigachat_published.json"
...
def get_news_from_gigachat():
    """Получение новостей через GigaChat API"""
    
    prompt = """Ты — профессиональный новостной аналитик. 
    
Найди в интернете 5 самых важных НОВОСТЕЙ из мира ИИ (искусственный интеллект) за последние 6 часов.
...
Отфильтруй ВСЮ ВОДУ. Только сухие факты и цифры. Если новости нет - напиши "НЕТ НОВОСТЕЙ"."""
...
def main():
    print("="*70)
    print("🤖 GIGACHAT NEWS AGENT")
    print("📡 Поиск новостей через ИИ")
    ...
    while True:
        ...
        # Получаем новости от GigaChat
        response = get_news_from_gigachat()
        ...
        # Публикуем первую непрочитанную
        published = False
